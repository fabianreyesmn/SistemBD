...
<body>
    ...
    <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="cambios.php">Cambios</a>
        </li>
        <li class="nav-item">
            ...
            switch ($opcion) {
                case 1: //Producto
                    ...
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                        ...
                        <button type="submit" name="submit">Modificar</button><br><br><br>
                    <?php
                    break;
                case 2: //Proveedor
                    ?>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
            ...
            switch ($tabla) {
                case 'producto':
                    ...
                    $sql = "UPDATE $tabla SET IdProducto='$IdProducto', nombreProd='$nombreProd', descripcion='$descripcion', precio='$precio', existencias='$existencias' WHERE IdProducto='$IdProducto';";
                    break;
                case 'proveedor':
                    ...
                    $sql = "UPDATE $tabla SET RFCProveedor='$RFCProveedor', nombreP='$nombreP', apellidoPP='$apellidoPP', apellidoMP='$apellidoMP' WHERE RFCProveedor='$RFCProveedor';";
                    break;
                case 'proveer':
                    $IdProductoT = $_POST["IdProductoT"];
                    $RFCProveedorT = $_POST["RFCProveedorT"];
                    $sql = "UPDATE $tabla SET IdProductoT='$IdProductoT', RFCProveedorT='$RFCProveedorT' WHERE IdProductoT='$IdProductoT' AND RFCProveedorT='$RFCProveedorT';";
                    break;
                case 'empleado':
                    ...
                    $sql = "UPDATE $tabla SET RFCEmpleado='$RFCEmpleado', nombreE='$nombreE', apellidoPE='$apellidoPE', apellidoME='$apellidoME' WHERE RFCEmpleado='$RFCEmpleado';";
                    break;
                case 'cliente':
                    ...
                    $correo = $_POST["correo"];
                    $sql = "UPDATE $tabla SET RFCCliente='$RFCCliente', nombreCliente='$nombreCliente', apellidoPC='$apellidoPC', apellidoMC='$apellidoMC' WHERE RFCCliente='$RFCCliente';";
                    break;
                case 'facturar':
                    ...
                    $sql = "UPDATE $tabla SET RFCEmpleadoT='$RFCEmpleadoT', RFCClienteT='$RFCClienteT', IdProductoT='$IdProductoT', total='$total', fecha='$fecha', numArticulos='$numArticulos' WHERE RFCEmpleadoT='$RFCEmpleadoT' AND RFCClienteT='$RFCClienteT' AND IdProductoT='$IdProductoT' AND fecha='$fecha';";
                    break;
                default:
                    echo "Error Fatal";
                    break;
